    ...
    <div className="min-h-screen bg-white">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-500 leading-relaxed max-w-lg">
                  Discover the finest collection of handpicked teas, artisan
                  coffees, and traditional snacks. From the serene tea gardens
                  to your cup, every sip tells a story.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-500 max-w-3xl mx-auto">
              Carefully curated selection of the world&apos;s finest teas,
              coffees, and traditional snacks
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group relative bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <div className="p-6">
                <p className="text-gray-500 mb-4">
                  Discover our handpicked collection of Earl Grey, Green Tea,
                  Masala Chai, and more exotic blends.
                </p>
            ...
            <div className="group relative bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <div className="p-6">
                <p className="text-gray-500 mb-4">
                  Premium Colombian, French Roast, and Espresso blends sourced
                  from the finest coffee farms.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-amber-500 font-semibold">
                    From $26.99
            ...
            <div className="group relative bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <div className="p-6">
                <p className="text-gray-500 mb-4">
                  Delicious Singara, Samosa, and other traditional snacks
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-700 mb-4">
              Why Choose Tea With Me?
            </h2>
            <p className="text-xl text-gray-500 max-w-3xl mx-auto">
              We&apos;re passionate about bringing you the finest tea and coffee
              experience
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              ...
              <p className="text-gray-500">
                Handpicked and sourced from the finest gardens worldwide
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-500">
                Daily fresh preparations to ensure maximum flavor and aroma
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-500">
                Every product crafted with care and traditional methods
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-500">
              Join thousands of satisfied tea and coffee lovers
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-500 mb-6 italic">
                &ldquo;The Earl Grey tea is absolutely divine! The quality and
                flavor are unmatched. It&apos;s become my daily ritual.&rdquo;
              </p>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-500 mb-6 italic">
                &ldquo;Best coffee beans I&apos;ve ever had! The Colombian blend
                is rich and perfect for my morning routine. Highly
                recommended!&rdquo;
              </p>
              <div className="flex items-center">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-500 mb-6 italic">
                &ldquo;The traditional snacks are authentic and delicious!
                Perfect companions for tea time. Fast delivery too!&rdquo;
              </p>
              <div className="flex items-center">
      ...
      <section className="py-20 bg-gradient-to-r from-amber-800 to-orange-900">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-amber-50 mb-8 max-w-2xl mx-auto">
            Join our community of tea and coffee enthusiasts. Get access to
            exclusive blends, special offers, and expert brewing guides.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center">
                ...
                >
                  <div className="w-8 h-8 bg-gradient-to-r from-amber-300 to-orange-300 rounded-full flex items-center justify-center">
                    <span className="text-white  font-bold italic text-4xl">
                      T
                    </span>
                  </div>
              ...
              <p className="text-gray-200 mb-6 max-w-md">
                Your premium destination for the finest teas, coffees, and
                traditional snacks. Bringing you authentic flavors from around
                the world.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-200">
                <li>📧 mynul.sakil@gmail.com</li>
                <li>📞 +88 015814-77504</li>
                <li>📍 Noakhali , Bangladesh</li>
          ...
          <div className="border-t border-gray-600 mt-12 pt-8 text-center">
            <p className="text-gray-300">
              &copy; 2025 Tea With Me. All rights reserved by <a href="https://github.com/sakil470004">Mynul Islam</a>. Made with ❤️ for tea
              lovers.
            </p>
          </div>
        </div>
