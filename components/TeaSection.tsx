...
export default function TeaSection() {
  ...
  const fetchTeaProducts = async () => {
    try {
      const response = await fetch('/api/products?category=tea&limit=4');
      if (response.ok) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Discover our finest selection of teas from around the world
            </p>
          </div>
    ...
    <section className="py-16 bg-gradient-to-r from-green-50 to-emerald-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Discover our finest selection of teas from around the world, each carefully sourced for exceptional quality and flavor
          </p>
        </div>
        ...
        {products.length === 0 && !isLoading && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Tea Products Found</h3>
            <p className="text-gray-600">Check back soon for our premium tea collection!</p>
          </div>
        )}

        {products.length > 0 && (
          <div className="text-center mt-12">
            <Link href="/categories/tea">
              <button className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-xl transition-all duration-300 transform hover:-translate-y-0.5 shadow-lg hover:shadow-xl font-semibold">
                View All Teas
